...
<template>
    ...
    <form class="LogInForm" @submit.prevent="logIn">
        ...
        <div class="LogInFormItem">
            ...
            <input required v-model="AuthModel.LoginOrEmail" id="login-email" class="LogInFormItem-input" type="text"
                placeholder="example@email.com" />
        </div>
        <div class="LogInFormItem">
            <label class="LogInFormItem-label" for="password">Password</label>
            <input required v-model="AuthModel.EncodedPassword" id="password" class="LogInFormItem-input"
