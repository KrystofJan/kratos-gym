 ...
 * @public
 */
declare function getNode(id: string): FormKitNode | undefined;
/**
 ...
 * @public
 */
declare function watchRegistry(id: string, callback: FormKitEventListener): void;
 ...
 * @internal
 */
declare const FORMKIT_VERSION = "1.5.9";
