var FormKitVue = (function (exports, Vue) {
  ...
  var runtimeProps, actions, box, boxHelp, boxInner, boxLabel, boxOption, boxOptions, boxWrapper, buttonInput, buttonLabel, decorator, fieldset, fileInput, fileItem, fileList, fileName, fileRemove, formInput, fragment, help, icon, inner, label, legend, message, messages, noFiles, optGroup, option, optionSlot, outer, prefix, selectInput, submitInput, suffix, textInput, textareaInput, wrapper, isBrowser, loading, radioInstance, button, checkbox, file, form2, group, hidden, list, meta, radio, select22, textarea, text2, inputs;
        ...
        schema: outer(
          /* @__PURE__ */ $if(
            ...
            boxWrapper(
              ...
              /* @__PURE__ */ $extend(boxLabel("$label"), {
                if: "$label"
              })
            ),
            /**
              ...
              boxOptions(
                boxOption(
                  boxWrapper(
                    ...
                    /* @__PURE__ */ $extend(boxLabel("$option.label"), {
                      if: "$option.label"
                    })
                  ),
                  boxHelp("$option.help")
          ...
          /* @__PURE__ */ $if("$options == undefined && $help", help("$help")),
          messages(message("$message.value"))
        ),
        /**
         * The type of node, can be a list, group, or input.
        ...
        schema: outer(
          wrapper(
            ...
            inner(
              ...
              /* @__PURE__ */ $if("$value.length > 1", fileRemove("$ui.removeAll.value")),
        ...
        schema: outer(
          wrapper(
            ...
            inner(
              ...
              /* @__PURE__ */ $if("$attrs.multiple !== undefined", () => "", icon("select")),
              suffix(),
              icon("suffix")
            )
          ),
  ...
  var init_dist6 = __esm({
    "packages/validation/dist/index.mjs"() {
      ...
      init_dist5();
      init_dist();
      validatingMessage = createMessage({
        type: "state",
        blocking: true,
        visible: false,
        value: true,
  ...
  var ui10, validation10, en, i18nNodes;
