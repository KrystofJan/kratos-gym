...
import { FormKitLibrary, FormKitPlugin, FormKitGroupValue, FormKitNode, FormKitFrameworkContext, FormKitMessage, FormKitClasses, FormKitSectionsSchema, FormKitTypeDefinition, FormKitSchemaNode, FormKitSchemaCondition, FormKitExtendableSchemaRoot, FormKitSchemaDOMNode, FormKitSchemaComponent, FormKitSchemaFormKit, FormKitMiddleware, FormKitSchemaDefinition, FormKitSchemaAttributes } from '@formkit/core';
 ...
 * @public
 */
type InputType<Props extends FormKitInputs<Props>> = Props['type'] extends string ? Props['type'] : 'text';
/**
 ...
 * @public
 */
type PropType<Props extends FormKitInputs<Props>, T extends keyof FormKitInputs<Props>> = Extract<FormKitInputs<Props>, {
