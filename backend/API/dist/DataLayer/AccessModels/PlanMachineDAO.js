...
var PlanMachinesDAO = /** @class */ (function (_super) {
    ...
    function PlanMachinesDAO() {
        return _super.call(this, TableTypes.PlanMachines) || this;
    }
    // TODO: Move logic to wrkOutPlan
    PlanMachinesDAO.prototype.SelectPlanBy_PlanId = function (id) {
    ...
    PlanMachinesDAO.prototype.SelectPlanBy_MachineId = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                try {
                    result = this.SecectByForeignId(id, TableTypes.Machine);
                    return [2 /*return*/, result];
                }
                catch (err) {
                    throw new DatabaseFail(err);
