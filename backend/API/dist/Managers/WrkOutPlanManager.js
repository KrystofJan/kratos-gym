...
export var AddMachineToPlan = function (body) { return __awaiter(void 0, void 0, void 0, function () {
    var wrkOutPlanMachineDao, result, successResult, err_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
...
export var AddMultipleMachinesToPlan = function (body) { return __awaiter(void 0, void 0, void 0, function () {
    var createdIds, _i, body_3, machine, wrkOutPlanMachineDao, result, successResult, err_5;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 5, , 6]);
                ...
                _a.label = 1;
            case 1:
                if (!(_i < body_3.length)) return [3 /*break*/, 4];
                machine = body_3[_i];
                wrkOutPlanMachineDao = new WrkOutPlanMachinesDAO();
...
export var CreateWrkOutPlan = function (body) { return __awaiter(void 0, void 0, void 0, function () {
    var result, wrkOutPlanDao, successResult, err_6;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
