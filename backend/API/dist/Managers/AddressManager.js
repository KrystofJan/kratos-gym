...
export var selectAllAdresses = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, addressDAO.getAll()];
            case 1:
                body = _a.sent();
                results = new Array();
...
export var selectAdressById = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                addressDAO = new AddressDAO();
                return [4 /*yield*/, addressDAO.get(id)];
            case 1:
                body = _a.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                addressDAO = new AddressDAO();
                return [4 /*yield*/, addressDAO.post(body)];
            case 1:
                result = _a.sent();
