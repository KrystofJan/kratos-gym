    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, reservationDao.SelectAllReservations()];
            case 1:
                body = _a.sent();
                results = [];
                for (_i = 0, body_1 = body; _i < body_1.length; _i++) {
                    b = body_1[_i];
                    a = new ReservationGetModel(b);
                    results.push(a);
                }
...
export var FindReservationById = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    var reservationDao, body, result, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                reservationDao = new ReservationDAO();
                return [4 /*yield*/, reservationDao.InsertReservation(body)];
            case 1:
                result = _a.sent();
