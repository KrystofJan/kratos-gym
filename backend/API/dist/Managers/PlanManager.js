...
export var FindPlanById = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    var wrkOutPlanDao, body, userDao, result, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, wrkOutPlanMachineDao.SelectPlanBy_PlanId(id)];
            case 1:
                body = _a.sent();
                result = [];
...
export var FindExerciseTypesContainedInId = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    var wrkOutPlanTypeDAO, body, result, err_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                wrkOutPlanTypeDAO = new PlanTypeDAO();
                return [4 /*yield*/, wrkOutPlanTypeDAO.SelectPlanTypeBy_PlanId(id)];
            case 1:
                body = _a.sent();
                ;
                result = [];
...
export var AddMultipleMachinesToPlan = function (body) { return __awaiter(void 0, void 0, void 0, function () {
    var createdIds, _i, body_1, machine, wrkOutPlanMachineDao, result, successResult, err_6;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 5, , 6]);
                ...
                _a.label = 1;
            case 1:
                if (!(_i < body_1.length)) return [3 /*break*/, 4];
                machine = body_1[_i];
                wrkOutPlanMachineDao = new PlanMachinesDAO();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                wrkOutPlanTypeDAO = new PlanTypeDAO();
                return [4 /*yield*/, wrkOutPlanTypeDAO.Insertpe(body)];
            case 1:
                result = _a.sent();
                successResult = result;
