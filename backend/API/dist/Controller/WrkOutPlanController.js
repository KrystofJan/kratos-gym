...
export var getAllWrkOutPlans = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var response;
    return __generator(this, function (_a) {
        switch (_a.label) {
...
export var postWrkOutPlan = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var body, response;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
export var postMachineToPlan = function (req, res, id) { return __awaiter(void 0, void 0, void 0, function () {
    var response, body_2, _i, _a, b, body;
        ...
        switch (_b.label) {
            case 0:
                ...
                for (_i = 0, _a = req.body; _i < _a.length; _i++) {
                    b = _a[_i];
                    body_2.push(new WrkOutPlanMachinePostModel(b));
                }
