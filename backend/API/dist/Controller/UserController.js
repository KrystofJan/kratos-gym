    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, LoginAuth(userAuth)];
            case 1:
                result = _a.sent();
...
export var Register = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var registerBody, result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                registerBody = new UserRegPostModel(req.body);
                return [4 /*yield*/, CreateUser(registerBody)];
            case 1:
                result = _a.sent();
                result.buildResponse(req, res);
                return [2 /*return*/];
...
export var GetId = function (req, res, id) { return __awaiter(void 0, void 0, void 0, function () {
    var result;
    return __generator(this, function (_a) {
        switch (_a.label) {
