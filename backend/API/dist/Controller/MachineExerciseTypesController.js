...
export var getMachineExerciseTypesByExerciseTypeId = function (req, res, id) { return __awaiter(void 0, void 0, void 0, function () {
    var response;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, FindMachineExerciteTypeByExerciseTypeId(id)];
            case 1:
                response = _a.sent();
                response.buildResponse(req, res);
                return [2 /*return*/];
...
export var postMachineExerciseTypes = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var machineExerciseType, response;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, CreateMachineExerciseType(machineExerciseType)];
            case 1:
                response = _a.sent();
                response.buildResponse(req, res);
                return [2 /*return*/];
