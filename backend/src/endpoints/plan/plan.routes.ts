...
PlanRouter.post('/:planId/machine/:machineId', async (req: Request, res: Response) => {
    await PlanController.AddMachine(req, res)
});

PlanRouter.post('/:planId/type/:typeId', async (req: Request, res: Response) => {
    await PlanController.AddType(req, res)
});

PlanRouter.delete('/:planId/machine/:machineId', async (req: Request, res: Response) => {
    await PlanController.RemoveMachineFromPlan(req, res)
});

PlanRouter.patch('/:planId/machine/:machineId', async (req: Request, res: Response) => {
    await PlanController.UpdateMachineByBothIds(req, res)
});

PlanRouter.delete('/:planId/type/:typeId', async (req: Request, res: Response) => {
