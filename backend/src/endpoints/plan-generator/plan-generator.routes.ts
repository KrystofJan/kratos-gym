...
import { GraphNode, Graph, compareTime, canFitInTime } from './graph.model'
...
generatorRouter.post('/', async (req: Request, res: Response) => {
    await PlanGeneratorController.FindAll(req, res)
})

// generatorRouter.post('/esketit', async (req: Request, res: Response) => {
