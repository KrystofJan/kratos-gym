...
export class ExerciseCategoryController {
    ...
    static async FindAll(req: Request, res: Response) {
        const [err, data] = await safeAwait(ExerciseCategoryService.GetAllExerciseCategories());
        if (err !== null) {
            logger.error(err)
    ...
    static async FindById(req: Request, res: Response) {
        ...
        const [err, data] = await safeAwait(ExerciseCategoryService.GetExerciseCategoryById(id));
        if (err !== null) {
            logger.error(err)
            const error = err as CodedError;
            const statusCode = exerciseCategoryErrorHandler.handleError(error);
    ...
    static async UpdateById(req: Request, res: Response) {
        ...
        const [err, data] = await safeAwait(ExerciseCategoryService.UpdateExerciseCategoryById(id, model))
    ...
    static async DeleteById(req: Request, res: Response) {
        const id = Number(req.params["id"])
        const [err, data] = await safeAwait(ExerciseCategoryService.DeleteExerciseCategoryById(id));
        if (err !== null) {
            logger.error(err)
            const error = err as CodedError;
            const statusCode = exerciseCategoryErrorHandler.handleError(error);
        ...
        const response = new DeletedResponse("Successfully deleted ExerciseCategory", data);
        response.buildResponse(req, res)
    }
    ...
    static async Create(req: Request, res: Response) {
        ...
        const [err, id] = await safeAwait(ExerciseCategoryService.CreateExerciseCategory(model));
        if (err !== null) {
