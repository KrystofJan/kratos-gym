...
export class ExerciseTypeService {
    ...
    static async UpdateExerciseTypeById(id: number, body: Partial<ExerciseType>): Promise<ExerciseType> {
        const db = new BasicQueryDatabase()
        ...
        if (databaseResponse.Body === undefined) {
            throw new CodedError(ErrorCode.NOT_FOUND_ERROR, `ExerciseType with an id: '${id}' was not Deleted`)
        }
