            ...
            <div class="flex flex-row justify-center gap-16 w-full">
                <draggable 
                  ...
                  <template #item="{element}">
                    <div class="flex justify-between h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background cursor-grab focus:cursor-grabbing">
                        <span>
                            {{element.MachineName}}
                        </span>
                        <GripHorizontal />
                ...
                <div 
                  ...
                  v-for="element in newSelectedMachines" 
                      >
                    <div class="flex justify-between h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background ">
                        <span>
                            {{element.MachineName}}
                        </span>
                        <GripHorizontal />
                ...
                <div class="w-1/3 flex flex-col gap-4" >
                    ...
                    <FormField v-slot="{ value, handleChange }" type="checkbox" name="canDisturb" v-if="isDisabled">
                      <FormItem v-auto-animate class="grid grid-cols-2 -order-1 w-full items-center gap-2 space-y-0">
                    ...
                    <FormField v-slot="{ value, handleChange }" type="checkbox" name="continuous" v-if="isDisabled">
                      <FormItem v-auto-animate class="grid grid-cols-2 -order-1 w-full items-center gap-2 space-y-0">
